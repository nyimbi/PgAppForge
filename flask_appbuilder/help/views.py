"""Help and training views for Flask-AppBuilder."""
...
TOPICS: dict[str, dict[str, str]] = {
	"getting-started": {
		...
		"content": """\
Flask-AppBuilder (FAB) is a rapid application development framework built on
...
Custom widget for JSONB
  ...
  fieldwidgets.py. The widgets_postgresql package (flask_appbuilder/widgets_postgresql/)
...
Built-in mixins (flask_appbuilder/mixins/)
...
Multi-tenant mixins (flask_appbuilder/mixins/)
...
<p class="text-muted">Step-by-step guides to mastering Flask-AppBuilder.</p>
...
TRAINING_MODULES: list[dict] = [
	{
		...
		"steps": [
			{
				"title": "Install Flask-AppBuilder",
