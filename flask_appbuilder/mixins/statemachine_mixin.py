"""
statemachine_mixin.py - Advanced State Machine System for Flask-AppBuilder

Provides a comprehensive state machine implementation with workflow management
for Flask-AppBuilder models. Event-driven architecture with full audit trail,
...
class HistoryManager:
	...
	@staticmethod
	def _db():
		from flask_appbuilder import db as _fab_db
		return _fab_db
...
class StateMachineMixin:
	"""
	Add declarative state machine behaviour to a Flask-AppBuilder / SQLAlchemy model.
