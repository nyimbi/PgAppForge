...
with Flask-AppBuilder models. Supports complex AND/OR conditions, sequential
...
# ---------------------------------------------------------------------------
# BusinessRuleMixin  — attach to Flask-AppBuilder Model subclasses
# ---------------------------------------------------------------------------

class BusinessRuleMixin:
	"""
	Adds a business-rules engine to any Flask-AppBuilder Model.
