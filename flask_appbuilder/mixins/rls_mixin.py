...
# ---------------------------------------------------------------------------
# Audit log table — appended to Flask-AppBuilder's shared metadata
# ---------------------------------------------------------------------------
...
class RowLevelSecurityMixin:
	"""
	PostgreSQL-first Row Level Security (RLS) mixin for Flask-AppBuilder ModelViews.
...
from flask_appbuilder.mixins.rls_mixin import generate_rls_policies_for_table
...
def downgrade():
    from flask_appbuilder.mixins.rls_mixin import _pg_drop_policy, _pg_disable_rls
...
from flask_appbuilder.mixins.rls_mixin import apply_pg_session_vars
