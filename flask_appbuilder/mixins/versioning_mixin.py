...
Temporal versioning mixin for Flask-AppBuilder SQLAlchemy models.
...
try:
	from flask_appbuilder import Model as _FABModel
	_BASE = _FABModel
except ImportError:
...
class VersioningMixin:
	"""
	Bi-temporal versioning mixin for Flask-AppBuilder SQLAlchemy models.
	...
	**Dependencies**:
	...
	def _session(self):
		"""Resolve the active SQLAlchemy session from Flask-AppBuilder or FSA."""
		# Try FAB db first
