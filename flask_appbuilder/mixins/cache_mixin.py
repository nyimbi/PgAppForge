...
Caching mixin for SQLAlchemy models in Flask-AppBuilder applications.
...
class CacheMixin(AuditMixin):
	...
	any Flask-AppBuilder / SQLAlchemy model.
	...
	::
		...
		from flask_appbuilder.mixins.cache_mixin import CacheMixin
