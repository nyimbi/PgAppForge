"""
flask_appbuilder/plugins/voice/__init__.py

FABVoicePlugin — integrates browser Web Speech API (SpeechRecognition +
SpeechSynthesis) into every Flask-AppBuilder page.
...
class FABVoicePlugin:
	"""
	Flask-AppBuilder voice input/output plugin.
	...
	Usage::
		...
		from flask_appbuilder.plugins.voice import FABVoicePlugin
