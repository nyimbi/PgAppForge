"""
Base plugin class and metadata structures for Flask-AppBuilder plugins.
...
class BasePlugin(abc.ABC):
    """
    Enhanced base class for Flask-AppBuilder plugins.
    ...
    def add_menu_item(self, name: str, href: str, category: str = None) -> None:
        ...
        # Implementation depends on Flask-AppBuilder's menu system
    ...
    def _cleanup_framework_resources(self) -> None:
        """Clean up Flask-AppBuilder resources."""
        # Remove registered views
        for view_info in self._registered_views:
            try:
                # Implementation depends on Flask-AppBuilder's cleanup methods
                # This is a placeholder for the actual implementation
                pass
            except Exception as e:
