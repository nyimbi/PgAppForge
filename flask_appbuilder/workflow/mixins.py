"""
Workflow Mixins for Flask-AppBuilder Models

Provides mixins that make any Flask-AppBuilder model workflow-aware,
...
class WorkflowMixin:
    """
    Mixin to make any Flask-AppBuilder model workflow-aware.
...
class WorkflowStateMixin:
    ...
    capabilities to Flask-AppBuilder views.
    """
