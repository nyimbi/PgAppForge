"""
Workflow-Aware Views for Flask-AppBuilder

Extends Flask-AppBuilder's ModelView and FormView to support workflow-driven
...
from flask_appbuilder import ModelView, SimpleFormView, expose, action, has_access
...
class WorkflowModelView(CollaborationMixin, WorkflowStateMixin, ModelView):
    ...
    This view extends Flask-AppBuilder's ModelView to provide:
