...
from pgappforge._compat import as_unicode, string_types
from pgappforge.baseviews import BaseCRUDView, BaseFormView, BaseView, expose, expose_api
from pgappforge.const import FLAMSG_ERR_SEC_ACCESS_DENIED, PERMISSION_PREFIX
from pgappforge.filemanager import uuid_originalname
from pgappforge.security.decorators import has_access, has_access_api, permission_name
from pgappforge.urltools import get_filter_args, get_order_args, get_page_args, get_page_size_args
from pgappforge.widgets import GroupFormListWidget, ListMasterWidget
...
class UtilView(BaseView):
    ...
    def back(self):
        ...
        Implementation follows PgAppForge patterns and standards.
...
class RestCRUDView(BaseCRUDView):
    ...
    def api_read(self):
        """
        Perform api read operation.

        This method provides functionality for api read.
        Implementation follows PgAppForge patterns and standards.
    ...
    def api_get(self, pk):
        """
        Perform api get operation.

        This method provides functionality for api get.
        Implementation follows PgAppForge patterns and standards.
    ...
    def api_readvalues(self):
        """
        Perform api readvalues operation.

        This method provides functionality for api readvalues.
        Implementation follows PgAppForge patterns and standards.
...
class CompactCRUDMixin(BaseCRUDView):
    ...
    @classmethod
    def del_key(cls, k):
        """Matching delete method for ``set_key``"""
        k = cls.__name__ + "__" + k
        session.pop(k)
