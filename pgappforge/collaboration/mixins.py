...
Provides mixins to add real-time collaboration capabilities to any PgAppForge
...
from pgappforge.baseviews import expose, BaseModelView
...
class CollaborativeModelViewMixin:
    ...
    def _check_collaboration_permission(self, user_id: int, model_name: str, 
        ...
        try:
            # Check with PgAppForge's security manager
