"""
Content Management Mixins for PgAppForge
...
These mixins are designed to work with PgAppForge's existing
...
class DocumentMixin(AuditMixin):
    """
    Document management mixin for PgAppForge.
...
def setup_content_mixins(app):
    """
    Set up content mixins with PgAppForge.
