...
This module provides tools for migrating existing PgAppForge applications
...
class MigrationHelper:
    """
    Helper class for migrating PgAppForge applications to use enhanced mixins.
    """
...
This directory contains the migration plan and scripts for integrating enhanced mixins into your PgAppForge application.
...
For issues or questions, refer to the PgAppForge enhanced mixins documentation.
