...
Git-like version control for SQLAlchemy models in PgAppForge.
...
class VersionControlMixin:
	"""
	Git-like version control mixin for PgAppForge SQLAlchemy models.
	...
	def _db_session(self):
		"""Resolve the SQLAlchemy session via PgAppForge's db extension."""
