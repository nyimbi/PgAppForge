"""
Standardized Exception Handling for PgAppForge

This module provides a comprehensive, standardized error handling system that can be used
throughout the PgAppForge framework. It builds on the existing FABException structure
...
class StandardizedFABException(FABException):
    ...
    def _log_security_event(self):
        ...
        security_logger = logging.getLogger('pgappforge.security.events')
        security_event = {
...
# Specific exception classes for common PgAppForge scenarios
...
class ErrorHandler:
    """Centralized error handler for PgAppForge operations."""
...
def fab_error_handler(category: Optional[ErrorCategory] = None,
                     ...
                     operation: Optional[str] = None):
    """
    Decorator for standardized error handling in PgAppForge operations.
