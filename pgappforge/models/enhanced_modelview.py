...
automatic exclusions, and improved user experience for PgAppForge applications.
...
try:
    ...
    from pgappforge.views import ModelView as BaseModelView
    HAS_FAB_MODELS = True
except ImportError:
    # Fallback for testing or when PgAppForge is not available
...
class EnhancedModelView(SmartExclusionMixin, BaseModelView if HAS_FAB_MODELS else object):
    ...
    This class extends the standard PgAppForge ModelView with intelligent
