...
class PartnerAccountView(ModelView):
	...
	label_columns = {
		...
		'partner_tier': _('Partner Tier'),
		'region': _('Region'),
		'country_code': _('Country Code'),
		'status': _('Status'),
		'ytd_revenue_cents': _('YTD Revenue Cents'),
	}
...
class DealRegistrationView(ModelView):
	...
	label_columns = {
		'partner_id': _('Partner Id'),
		'opportunity_name': _('Opportunity Name'),
		'customer_name': _('Customer Name'),
		'estimated_value_cents': _('Estimated Value Cents'),
...
class MDFRequestView(ModelView):
	...
	label_columns = {
		...
		'amount_requested_cents': _('Amount Requested Cents'),
		'approved_cents': _('Approved Cents'),
		'period': _('Period'),
		'status': _('Status'),
	}
	add_exclude_columns = ['id', 'created_on', 'changed_on']
