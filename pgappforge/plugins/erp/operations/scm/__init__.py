...
class SCMPlugin(BasePlugin):
    ...
    def get_events(self) -> list[str]:
        return [
            ...
            "scm.purchase_requisition.created",
            "scm.purchase_requisition.approved",
            "scm.purchase_order.created",
            "scm.goods_receipt.created",
            "scm.supplier_invoice.matched",
            "scm.supplier_invoice.disputed",
