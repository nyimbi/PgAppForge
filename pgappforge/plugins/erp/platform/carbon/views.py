...
class EmissionRecordView(ModelView):
	...
	label_columns = {
		...
		'activity_data': _('Activity Data'),
		'unit': _('Unit'),
		'emission_factor_id': _('Emission Factor'),
		'co2e_kg': _('CO2e kg'),
		'period': _('Period'),
		'entity_id': _('Entity'),
...
class GHGReportView(ModelView):
	...
	label_columns = {
		'tenant_id': _('Tenant'),
		'period': _('Period'),
		'scope1_co2e_kg': _('Scope 1 CO2e kg'),
		'scope2_co2e_kg': _('Scope 2 CO2e kg'),
		'scope3_co2e_kg': _('Scope 3 CO2e kg'),
		'total_co2e_kg': _('Total CO2e kg'),
