...
Provides synchronous interface for PgAppForge views to interact
with the async ProcessEngine, following PgAppForge patterns.
"""
...
class ProcessService:
    ...
    Provides PgAppForge compatible synchronous interface while
    ...
    def resume_process(self, instance_id: int, resume_data: Dict[str, Any] = None) -> bool:
        ...
        try:
            ...
            # For PgAppForge views, delegate to Celery for async work
