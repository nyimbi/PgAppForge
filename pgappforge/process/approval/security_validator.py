...
try:
    ...
    from pgappforge.security.mfa.models import UserMFA, MFAPolicy
...
class ApprovalSecurityValidator:
    ...
    def __init__(self, appbuilder):
        """
        Initialize the security validator with PgAppForge instance.
        
        Args:
            appbuilder: PgAppForge instance for security integration
        """
    ...
    def validate_user_role(self, user, required_role: str, allow_admin_override: bool = False) -> bool:
        """
        Validate user has required role using PgAppForge security.
    ...
    def _validate_admin_override(self, user, required_role: str) -> bool:
        ...
        if SecurityConstants.LOG_ADMIN_OVERRIDE_USAGE:
            ...
            warnings.warn(
                ...
                "This feature will be removed in PgAppForge 5.0.",
                DeprecationWarning,
                stacklevel=3
            )
    ...
    def _is_mfa_configured(self) -> bool:
        """
        Check if MFA is configured in the PgAppForge application.
    ...
    def _is_mfa_required_for_approval(self, user, approval_level: str) -> bool:
        ...
        try:
            ...
            from pgappforge.security.mfa.services import MFAPolicyService
