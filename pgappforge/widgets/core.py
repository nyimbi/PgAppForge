...
class ApprovalWidget(FormWidget):
    """
    Widget for adding approval functionality to PgAppForge forms.
    
    Integrates with existing PgAppForge security system to provide
    ...
    def _can_approve_user(self, user):
        ...
        # Check standard PgAppForge permissions
