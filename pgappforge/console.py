...
SQLA_REPO_URL = (
    "https://github.com/dpgaspar/PgAppForge-Skeleton/archive/master.zip"
)
MONGOENGIE_REPO_URL = (
    "https://github.com/dpgaspar/PgAppForge-Skeleton-me/archive/master.zip"
)
ADDON_REPO_URL = (
    "https://github.com/dpgaspar/PgAppForge-Skeleton-AddOn/archive/master.zip"
)


def import_application(app_package, appbuilder):
    """
    Import and return the PgAppForge application instance.
    
    This function dynamically imports a Python package and retrieves the
    PgAppForge instance from it. It's used by the CLI commands to
    ...
    Returns:
        The PgAppForge application instance
...
def create_app(name, engine):
    ...
    try:
        if engine.lower() == "sqlalchemy":
            ...
            dirname = "PgAppForge-Skeleton-master"
        elif engine.lower() == "mongoengine":
            url = urlopen(MONGOENGIE_REPO_URL)
            dirname = "PgAppForge-Skeleton-me-master"
...
def create_addon(name):
    ...
    try:
        ...
        dirname = "PgAppForge-Skeleton-AddOn-master"
