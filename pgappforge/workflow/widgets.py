"""
Workflow-Aware Widget System for PgAppForge
...
class WorkflowFormWidget(FormWidget):
    ...
    Extends PgAppForge's FormWidget to include workflow-specific
...
class WorkflowListWidget(ListWidget):
    ...
    Extends PgAppForge's ListWidget to display workflow-specific
...
class WorkflowShowWidget(ShowWidget):
    ...
    Extends PgAppForge's ShowWidget to show workflow progress,
...
class WorkflowSearchWidget(SearchWidget):
    ...
    Extends PgAppForge's SearchWidget to include workflow status,
