"""
AI Chatbot service for PgAppForge collaborative features.
...
class ChatbotConversation(Model, AuditMixin):
    """Chatbot conversation storage with PgAppForge integration."""
...
class ChatbotMessage(Model, AuditMixin):
    """Individual chatbot messages with PgAppForge integration."""
