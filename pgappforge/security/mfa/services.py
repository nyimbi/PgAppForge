...
class TOTPService:
    ...
    def __init__(self):
        ...
        self.issuer = current_app.config.get('MFA_TOTP_ISSUER', 'PgAppForge')
    ...
    def generate_qr_code(self, secret: str, user_email: str, 
        ...
        if not HAS_QRCODE:
            raise RuntimeError(
                ...
                "Install with: pip install 'PgAppForge[mfa]'"
            )
...
class SMSService:
    ...
    def _initialize_providers(self) -> Dict[str, Any]:
        ...
        if twilio_sid and twilio_token and twilio_from and HAS_TWILIO:
            ...
            log.warning("Twilio credentials configured but twilio library not available. Install with: pip install 'PgAppForge[mfa]'")
...
class WebAuthnService:
    ...
    def __init__(self):
        ...
        self.rp_name = current_app.config.get('WEBAUTHN_RP_NAME', 'PgAppForge')
