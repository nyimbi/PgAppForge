...
from pgappforge.charts.views import DirectByChartView
from pgappforge.exceptions import (
    DeleteGroupWithUsersException,
    DeleteRoleWithUsersException,
)
from pgappforge.fieldwidgets import BS3PasswordFieldWidget
from pgappforge.security.decorators import has_access, no_cache
from pgappforge.security.forms import (
    DynamicForm,
    LoginForm_db,
    LoginForm_oid,
    ResetPasswordForm,
...
from pgappforge.security.utils import generate_random_string
from pgappforge.utils.base import get_safe_redirect, lazy_formatter_gettext
from pgappforge.validators import PasswordComplexityValidator
from pgappforge.views import expose, ModelView, SimpleFormView
...
class ViewMenuModelView(ModelView):
    """
    PgAppForge view for view menu model operations.

    This view provides CRUD operations for view menu management.
    """
...
class PermissionViewModelView(ModelView):
    """
    PgAppForge view for permission view model operations.
    
    This view provides CRUD operations for permission view management.
    """
...
def _roles_custom_formatter(string: str) -> str:
    """
    Custom formatter for roles field that adds warning about AUTH_ROLES_SYNC_AT_LOGIN.
    
    Args:
        string: The input string to format
        
    Returns:
        Formatted string with optional warning message
    """
...
class UserModelView(ModelView):
    ...
    def userinfo(self) -> WerkzeugResponse:
        ...
        Returns:
            WerkzeugResponse: The rendered user info page
        """
