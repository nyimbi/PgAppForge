...
from pgappforge.exceptions import FABException, InvalidLoginAttempt, OAuthProviderUnknown
...
class BaseSecurityManager(AbstractSecurityManager, InputValidationMixin, RateLimitingMixin):
    ...
    Attributes:
        appbuilder: Reference to the PgAppForge instance

        >>> # Use instance methods to perform operations
        >>> result = instance.main_method()

    Note:
        This manager class follows the PgAppForge manager pattern
