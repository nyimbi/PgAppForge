"""
PgForge Workflow Generation CLI Commands
...
@click.option('--app-name', '-n', required=True, help='Name of the PgForge application')
...
def generate_workflow(workflow_file: str, app_name: str, output_dir: str, format: str, 
    ...
    """Generate PgForge code from workflow definition.
    ...
    """
    try:
        click.echo("🚀 JHipster-inspired PgForge Workflow Generation")
        click.echo("=" * 60)
        ...
        # Generate code
        click.echo()
        click.echo("🏗️  Generating PgForge application...")
        ...
        try:
            ...
            click.echo("2. Integrate with your PgForge application")
